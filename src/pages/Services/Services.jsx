...
function Services({}) {
  return (
    <section className="serviceSection">
      ...
      <h3>
        Pregnancy & Birth Plan Consultation <span>$60 for 2 hours</span>
      </h3>
      <p>
      ...
      <p className="bottomBlurb">
        This time is for you, so I encourage you to bring your birth partner and
        come with questions!
      </p>
      ...
      <ul>
        ...
        <li>
          availability virtually 24/7 via phone call/texting/emails throughout
          your entire pregnancy
        </li>
        <li>on call two weeks prior to the due date until the baby arrives</li>
        <li>
          breastfeeding education and connecting to lactation consultants if
          needed
        </li>
        <li>
          discussing mental health throughout pregnancy and connecting you to
          resources needed
        </li>
        <li>2 hour postpartum care</li>
        <li>
          up to 2 weeks virtual postpartum check ins and answering questions if
          needed!
        </li>
      </ul>

      <p className="bottomBlurb">
        If your labor allows, I will also happily take photos as we go through
        the labor process.
      </p>
      ...
      <ul>
        ...
        <li>2 weeks postpartum care to connect you to lactation consultants</li>
        <li>mental health resources or any other care you may need.</li>
      </ul>

      <p className="bottomBlurb">
        If your labor allows, I will be happy to take some photos of your birth
        as well.
      </p>

...
function FAQs({}) {
  ...
  const answers = [
    ...
    "I generally offer two birth doula packages. One package is birth support and postpartum support combined, and the other is birth support only. They both include 2-3 prenatals and a postpartum visit. I can customize packages based on your needs if this is helpful.",

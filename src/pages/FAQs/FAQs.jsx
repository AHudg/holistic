...
function FAQs({}) {
  ...
  const answers = [
    ...
    "I am located in Bryan, TX, but I will serve up to 2 hours within the radius of where I live! These areas include: Katy, Franklin, Hearne, Iola, Normangee, Anderson, Caldwell, Navasota, New Waverly, Huntsville, Conroe, Brenham, The Woodlands, Cypress, Spring, Rosenberg, Sugarland, and more! If you are curious if I will serve you, please just feel free to call or text me! I would love to chat with you :)",

...
function FAQs({}) {
  ...
  const answers = [
    "Doula is the professional name for someone who is your support— educationally, mentally, emotionally, and at times physically! There are two types of doulas: birth doulas and postpartum doulas. I am a certified birth doula who is excited to walk alongside you through your pregnancy and labor. It is important to mention that doulas are non-medical professionals and do not offer medical advice or practices. I believe birth was designed by God, and it belongs to women. My heart behind this profession is to provide education for my families to make informed decisions about and for their birth plan. Pregnancy and labor can be overwhelming, and no one should have to sift through the information alone. Doulas work with your partner, not against them, to create an environment where you feel safe, comfortable, and in charge of your birth.",
    "Research has shown that having a doula in your birth can decrease your stress during pregnancy and positively impact the labor process. Doulas make a great advocate for birth plans and are on your team. We can offer that extra support to make your birth experience that much more enjoyable and ensure that you feel empowered and prepared for birth. Whether you are a first time mom or are looking for a different birth experience, we are here to help you through pregnancy and labor. Doulas can help to decrease your chances of ending up in a cesarean section, to avoid complications during birth, to lessen the risk of instrumental vaginal deliveries, and to decrease likelihood of dissatisfaction with the birth experience.",
    "I am located in Bryan, TX, but I will be moving to the New Waverly area spring of 2026! I will still absolutely serve my BCS mamas; just note that I will be about 50 minutes away. Additionally, I serve up to 2 hours within the radius of where I live. These areas include: Katy, Franklin, Hearne, Iola, Normangee, Anderson, Caldwell, Navasota, New Waverly, Huntsville, Conroe, Brenham, The Woodlands, Cypress, Spring, Rosenberg, Sugarland, and more! If you are curious if I will serve you, please just feel free to call or text me! I would love to chat with you :)",
    "I generally offer three birth doula packages which are education consultations, the labor day only plan, or a full pregnancy plan (i.e., walking with you through the pregnancy and labor). I also offer a postpartum package for day or night help. These are focused on helping you adjust to life at home with a newborn.",
    ...
    "Postpartum check ins can vary based on what you need! I normally check in with breastfeeding to see how that has been progressing. I also love to offer meals or some help with household chores. You are welcome to reach out to me about anything mental or physical health related, but as a nonmedical professional I will most likely just connect you to someone who specializes in that field. We can discuss what you think you may want this to look like in our prenatal meeting.",

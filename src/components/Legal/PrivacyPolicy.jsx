  ...
  return (
    <div className="background">
      <article>
        ...
        <p>
          <span>1. Introduction</span>Welcome to [Your Company Name] ("Company,"
          ...
          and protect your information when you use our website, [Your Website
          URL] ("Website").
        </p>
        <p>
        ...
        <p>
          ...
          Your information is strictly confidential and is used only by [Your
          Company Name] for the purposes described in this Privacy Policy.
        </p>
        <p>
        ...
        <p>
          <span>8. Contact Us</span>If you have any questions or concerns about
